...
st.set_page_config(
    page_title="Player Comparison – Ealing Recruitment Tool",
    layout="wide",
)
...
st.markdown("<h1 style='font-size:42px;'>Player Comparison – Radar & Percentiles</h1>", unsafe_allow_html=True)
...
for i in range(6):
    current_value = st.session_state.compare_players[i]
...
st.session_state.compare_players = new_selections
...
def build_radar(player_name, row, descriptors, players):
...
# Compute league averages per metric (50th percentile)
league_avg = []
